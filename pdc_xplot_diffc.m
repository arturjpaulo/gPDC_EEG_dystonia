...
function [hxlabel,hylabel] = pdc_xplot_diffc(c,...
      ...
      if j == i, %Power spectrum
         ...
         if flgPrinting(7), % Power spectrum linear scale
            ...
            switch flgPrinting(7)
               case {1,2}
                  set(h12,'LineWidth',2.5,'Color',[0 0 1]);
               case 3
                  if flgPrinting(2)==1
                  ...
                  if flgPrinting(3)
                     atrib='g-'; % Significant PDCn in red line
                     plot(h,w,abs(getCij(LTra,r,s,nPlotPoints)), ... 
                        atrib,'LineWidth',2.5);
                     hold on
                  end;
               case {4,5}
                  set(h1,'LineWidth',2.5,'Color',[0 0 1]);
                  ...
                  if flgPrinting(3)
                     atrib='b-'; % Significant PDCn in red line
                     plot(h,w,abs(getCij(LTra,r,s,nPlotPoints)), ...
                        atrib,'LineWidth',1.5);
                     hold on
                  end;
...
% Plot lower and upper bound of significance level
      if flgPrinting(4) || flgPrinting(5),
         ...
         if flgPrinting(4) && flgSignif
            atrib='k--'; % Lower-bound significant interval in blue -- line
      ...
      if flgPrinting(3),
         ...
         plot(h,w,abs(getCij(LTra,r,s,nPlotPoints)),atrib,'LineWidth',2.5);
         end;
