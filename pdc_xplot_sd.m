...
function [hxlabel,hylabel] = pdc_xplot_sd(c,sd,...
...
%==========================================================================
         ...
         if flgPrinting(1),
            ...
            plot(h,w,abs(getCij(L,r,s,nPlotPoints)),atrib,'LineWidth',2);
            errorbar([h,w,abs(getCij(L,r,s,nPlotPoints)),sd)
            grid off
...
% Plot lower and upper bound of significance level
      if flgPrinting(4) || flgPrinting(5),
         ...
         if flgPrinting(4) && flgSignif
            ...
            plot(h,w,temp, atrib,'LineWidth',1);
         end;
      ...
      if flgPrinting(3),
         atrib='r-'; % Significant PDCn in red line
         plot(h,w,abs(getCij(LTra,r,s,nPlotPoints)),atrib,'LineWidth',1,'Color',[.94 .7 .7]);
         end;
