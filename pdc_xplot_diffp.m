function [hxlabel,hylabel] = pdc_xplot_diffp(c,...
      ...
      if j == i, %Power spectrum
         ...
         if flgPrinting(7), % Power spectrum linear scale
            ...
            elseif flgPrinting(7)==3,
               atrib = 'r-';
               plot(h,w,abs(getCij(L,r,s,nPlotPoints)),atrib,'LineWidth',2.5);
               ax(1)=gca;
               ax(2)=ax(1);
            ...
            switch flgPrinting(7)
               case {1,2}
                  set(h12,'LineWidth',1.5,'Color',[0 0 0]);
               case 3
                  if flgPrinting(2)==1
                  ...
                  if flgPrinting(3)
                     atrib='m-'; % Significant PDCn in red line
...
%==========================================================================
         ...
         if flgPrinting(1),
            ...
            plot(h,w,abs(getCij(L,r,s,nPlotPoints)),atrib,'LineWidth',1.5);
            grid off
...
% Plot lower and upper bound of significance level
      if flgPrinting(4) || flgPrinting(5),
         ...
         if flgPrinting(5) && flgSignif
            atrib='r-'; % Upper-bound significant interval in blue -- line
      ...
      if flgPrinting(6), %Coh plot in gray-line
         plot(w,abs(getCij(Coh,r,s,nPlotPoints)),'-','LineWidth',2.5, ...
                                               'Color',[.7 .7 .7]);
      end;
      if flgPrinting(3),
         atrib='r-'; % Significant PDCn in red line
         plot(h,w,abs(getCij(LTra,r,s,nPlotPoints)),atrib,'LineWidth',1);
         end;
